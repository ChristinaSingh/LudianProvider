...
import com.ludianseller.databinding.ActivitySignupBinding
...
class SignupAct :  AppCompatActivity(){
    ...
    private fun initViews() {
       // I agree to the medidoc Terms of Service and Privacy Policy
        ...
        if (sharedPrf.getStoredTag(SharedPrf.LANGUAGE) == "ar") {
            ...
            spannableString.setSpan(ForegroundColorSpan(getColor(R.color.color_primary)), 44, spannableString.length, 0);
    ...
    private fun bindObservers() {
        authViewModel.sellerResponseLiveData.observe(this, Observer {
