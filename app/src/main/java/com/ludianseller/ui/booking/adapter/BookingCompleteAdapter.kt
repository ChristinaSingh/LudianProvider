...
import com.ludianseller.databinding.ItemBookingCompleteBinding
...
class BookingCompleteAdapter (
    ...
    class MyViewHolder(var binding: ItemBookingCompleteBinding) :
        RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding: ItemBookingCompleteBinding = DataBindingUtil.inflate(
            LayoutInflater.from(mContext), R.layout.item_booking_complete, parent, false
        )
    ...
    //    holder.binding.tvDateTime.text =    "From : ${arrayList!![position].booking_request_date_start}"
      ...
      //  holder.binding.tvAddress.ellipsize = TextUtils.TruncateAt.END
        ...
        holder.binding.tvAccept.setOnClickListener {
            mContext.startActivity(Intent(mContext, BookingCompleteInfoAct::class.java)
