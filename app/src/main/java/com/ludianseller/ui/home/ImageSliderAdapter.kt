...
class ImageSliderAdapter(private val mContext : Context,private val images: List<PropertyModel.Property.PropertyImage>) : RecyclerView.Adapter<ImageSliderAdapter.ImageViewHolder>() {
