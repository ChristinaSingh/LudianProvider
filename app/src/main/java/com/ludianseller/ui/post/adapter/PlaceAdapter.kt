...
class PlaceAdapter (
    ...
    var arrayList: ArrayList<PlaceModel.Property>?
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            listener.onPlace(arrayList!!,position)
        }
    }

    interface   OnPlaceListener{
        fun onPlace(propertyList: ArrayList<PlaceModel.Property>, position: Int)

    }


    fun notifyAdapter(propertyList: ArrayList<PlaceModel.Property>) {
