...
import com.ludianseller.databinding.ActivityEditProfileBinding
...
class EditProfileAct : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (validationResult.first) {
                ...
                sellerDataViewModel.updateProfile(token,userId,firstName,lastName,email,mobile,profileFilePart)
    ...
    private fun validateUserInput(): Pair<Boolean, String> {
        ...
        return sellerDataViewModel.validateProfile(
            this@EditProfileAct,
            fName,
            lName,
            emailAddress,
    ...
    private val pickFromGallery =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                binding.ivImage.setImageURI(Uri.parse(path))
    ...
    private fun bindObservers() {
        sellerDataViewModel.sellerResponseLiveData.observe(this, Observer {
